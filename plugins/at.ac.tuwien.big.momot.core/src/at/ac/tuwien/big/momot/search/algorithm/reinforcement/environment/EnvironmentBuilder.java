   ...
   public Map<IEnvironment.Type, IEnvironment<S>> build() {
      ...
      if(this.encodingStrategy != null && (this.objectiveName != null || this.rewardStrategy != null)) {
         environmentMap.put(IEnvironment.Type.PolicyBasedEnvironment,
               new SOEnvironment<>(fitnessFunction,
                     new ObjectiveFitnessComparator<>(fitnessFunction.getObjectiveIndex(objectiveName)), objectiveName,
                     this.rewardStrategy, this.encodingStrategy));
      }
      ...
      environmentMap.put(IEnvironment.Type.MOValueBasedEnvironment, new MOEnvironment<>(fitnessFunction, comparatorList,
            fitnessFunction.getObjectiveNames(), this.encodingStrategy));
