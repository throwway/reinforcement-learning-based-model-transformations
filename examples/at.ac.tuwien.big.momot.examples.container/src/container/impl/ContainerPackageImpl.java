...
public class ContainerPackageImpl extends EPackageImpl implements ContainerPackage {
    ...
    * @generated
    */
   public EAttribute getContainerModel_TravelDistance() {
      return (EAttribute)containerModelEClass.getEStructuralFeatures().get(3);
   }
   ...
   public void createPackageContents() {
      ...
      createEAttribute(containerModelEClass, CONTAINER_MODEL__TRAVEL_DISTANCE);
   ...
   public void initializePackageContents() {
      ...
      initEAttribute(getContainerModel_TravelDistance(), ecorePackage.getEInt(), "travelDistance", "0", 0, 1, ContainerModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      ...
      initEAttribute(getStack_Position(), ecorePackage.getEInt(), "position", null, 0, 1, Stack.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
