 ...
 *   <li>{@link container.impl.StackImpl#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StackImpl extends MinimalEObjectImpl.Container implements Stack {
   ...
   public void setPosition(int newPosition) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, ContainerPackage.STACK__POSITION, oldPosition, position));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case ContainerPackage.STACK__POSITION:
            return getPosition();
      }
