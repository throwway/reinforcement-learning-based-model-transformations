...
public class SOContainerSearch {
   ...
   protected static final String CASE = "5S_20C";
   ...
   protected IFitnessDimension<TransformationSolution> _createObjective_1(
         final TransformationSearchOrchestration orchestration) {
      return new AbstractEGraphFitnessDimension("ContainerIndex",
   ...
   protected TransformationSearchOrchestration createOrchestration(final String initialGraph,
      ...
      final Map<IEnvironment.Type, IEnvironment<TransformationSolution>> env = envBuilder
            .singleObjective("ContainerIndex").build();
      ...
      orchestration.addAlgorithm("QLearningExplore", rl.createSingleObjectiveExploreQLearner(5, 0.9, 1.0, true,
            (1.0 - .05) / maxEvaluations, 0.05, "QExplore-BRP-" + CASE, 10, 0, null, null, false));

      orchestration.addAlgorithm("QLearning", rl.createSingleObjectiveQLearner(0.9, 1.0, true,
            (1.0 - .05) / maxEvaluations, 0.05, "Q-BRP-" + CASE, 10, 0, null, null, false));
