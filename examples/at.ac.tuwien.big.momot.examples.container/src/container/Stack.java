 ...
 *   <li>{@link container.Stack#getPosition <em>Position</em>}</li>
 * </ul>
 *
...
public interface Stack extends EObject {
    ...
    * @see #setPosition(int)
    * @see container.ContainerPackage#getStack_Position()
    * @model
    * @generated
    */
   int getPosition();
   ...
   /**
    * Sets the value of the '{@link container.Stack#getPosition <em>Position</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
