 ...
 *   <li>{@link container.ContainerModel#getTravelDistance <em>Travel Distance</em>}</li>
 * </ul>
 *
...
public interface ContainerModel extends EObject {
   ...
   /**
    * Returns the value of the '<em><b>Travel Distance</b></em>' attribute.
    * The default value is <code>"0"</code>.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the value of the '<em>Travel Distance</em>' attribute.
    * @see #setTravelDistance(int)
    * @see container.ContainerPackage#getContainerModel_TravelDistance()
    * @model default="0"
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link container.ContainerModel#getTravelDistance <em>Travel Distance</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @param value the new value of the '<em>Travel Distance</em>' attribute.
