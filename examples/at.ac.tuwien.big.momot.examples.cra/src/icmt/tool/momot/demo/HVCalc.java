...
public class HVCalc {
   ...
   private static String CASE_PATH = "transformations/tmp/";
   ...
   public static void main(final String... args) throws IOException, ClassNotFoundException {
      ...
      final String initialGraph = "model/TTC_InputRDG_D.xmi";
      ...
      orchestration.setSolutionLength(160);
      orchestration.setFitnessFunction(createFitnessFunction(orchestration));

      final NondominatedPopulation referenceSet = buildReferenceSet(CASE_PATH, "Chebycheff-10", "NSGAII-2",
            "PQ-HV-Local10", "PQ-PO-Local10", "Tournament-Local10");
      ...
      sb = computeStatistics(orchestration.getProblem(), referenceSet, CASE_PATH, sb, CASE_PATH, "Chebycheff-10",
            "NSGAII-2", "PQ-HV-Local10", "PQ-PO-Local10", "Tournament-Local10");
